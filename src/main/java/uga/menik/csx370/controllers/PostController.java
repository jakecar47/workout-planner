...
public class PostController {
    ...
    public ModelAndView webpage(@PathVariable("postId") String postId,
        ...
        try {
            ...
            String errorMessage = "Failed to load the post. Please try again.";
    ...
    public String addOrRemoveHeart(@PathVariable("postId") String postId,
        ...
        try {
            postService.heartPost(Integer.parseInt(postId), isAdd);
            return "redirect:/post/" + postId;
        } catch (Exception e) {
    ...
    public String addOrRemoveBookmark(@PathVariable("postId") String postId,
        ...
        try {
            postService.bookmarkPost(Integer.parseInt(postId), isAdd);
            return "redirect:/post/" + postId;
        } catch (Exception e) {
